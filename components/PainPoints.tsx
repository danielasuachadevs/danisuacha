...
export default function PainPoints() {
  const cards = [
    ...
    {
      title: "Relaciones",
      description: "Conflictos de pareja, relaciones repetitivas o conflictivas, dificultad para establecer límites, dependencia emocional.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor">
    ...
    },
    {
      ...
      description: "Ansiedad o estrés, tristeza profunda, miedos o inseguridades, culpa o sensación de no merecimiento, dificultad para tomar decisiones.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor">
    ...
    },
    {
      ...
      description: "Bloqueos económicos, creencias limitantes sobre el dinero, falta de confianza personal, dificultad para avanzar en proyectos o metas.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor">
...
la biodesprogramación?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, index) => (
            <div 
              key={index} 
              className="group bg-white p-8 rounded-xl border border-primary/5 hover:border-primary/20 shadow-sm hover:shadow-md transition-all duration-300 hover-lift animate-fade-in-up"
