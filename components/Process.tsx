...
export default function Process() {
  const { t } = useLanguage();
  const steps = t('steps', 'process') as any[];

  return (
    <section className="py-20 px-6 lg:px-20 bg-surface-light border-y border-primary/10 overflow-hidden">
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="font-serif text-3xl text-gray-deep mb-4">{t('title', 'process')}</h2>
          <p className="text-black font-sans">{t('subtitle', 'process')}</p>
        </div>
