...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary py-12 px-4 lg:px-20 border-t border-white/10 overflow-hidden relative font-sans">
      ...
      <div className="mx-auto max-w-7xl text-center animate-fade-in-up relative z-10" style={{ animationFillMode: 'forwards' }}>
        ...
        <h3 className="font-serif text-2xl text-white mb-6">{t('title', 'footer')}</h3>
        
        <nav className="flex flex-wrap justify-center gap-x-4 sm:gap-x-8 gap-y-4 mb-10">
          <Link 
            href="#hero" 
        ...
        <div className="text-xs text-white/50 space-y-2 font-sans">
          ...
          <p className="mt-4 pt-4 border-t border-white/10">
            {t('developedBy', 'footer')} <Link href="https://blackcherrydevs.vercel.app/" target="_blank" className="font-bold text-white hover:underline">BlackCherry IT Consulting</Link>
          </p>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
          ...
          >
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
              <h2 className="text-xl font-bold text-gray-deep font-serif">{t('privacyModal.title', 'footer')}</h2>
              <button 
            ...
            <div className="p-8 overflow-y-auto font-sans text-slate-700 dark:text-slate-300 leading-relaxed space-y-6">
              <section>
                <h3 className="font-bold text-gray-deep mb-2">{t('privacyModal.sec1.t', 'footer')}</h3>
                <p>{t('privacyModal.sec1.d', 'footer')}</p>
              </section>
              <section>
                <h3 className="font-bold text-gray-deep mb-2">{t('privacyModal.sec2.t', 'footer')}</h3>
                <p>{t('privacyModal.sec2.d', 'footer')}</p>
              </section>
              <section>
                <h3 className="font-bold text-gray-deep mb-2">{t('privacyModal.sec3.t', 'footer')}</h3>
                <p>{t('privacyModal.sec3.d', 'footer')}</p>
              </section>
              <section>
                <h3 className="font-bold text-gray-deep mb-2">{t('privacyModal.sec4.t', 'footer')}</h3>
                <p>{t('privacyModal.sec4.d', 'footer')}</p>
              </section>
              <section>
                <h3 className="font-bold text-gray-deep mb-2">{t('privacyModal.sec5.t', 'footer')}</h3>
                <p>{t('privacyModal.sec5.d', 'footer').replace('dansuacha@gmail.com', '')}<Link href="mailto:dansuacha@gmail.com" className="font-bold text-primary">dansuacha@gmail.com</Link>.</p>
              </section>
            </div>
