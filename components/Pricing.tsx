...
export default function Pricing() {
  ...
  return (
    <section className="py-24 px-4 lg:px-20 bg-white overflow-hidden" id="pricing">
      <div className="mx-auto max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Highlighted Card */}
          <div className="relative bg-white p-6 sm:p-8 md:p-10 rounded-2xl border-2 border-primary shadow-xl shadow-primary/10 flex flex-col items-center text-center overflow-hidden group">
            <div className="absolute top-0 right-0 bg-primary text-white text-xs font-bold px-3 py-1 rounded-bl-lg uppercase">{t('badge', 'pricing')}</div>
            <h3 className="font-serif text-xl sm:text-2xl text-gray-deep mb-4 break-words">{t('title1', 'pricing')}</h3>
          ...
          {/* Neutral Card */}
          <div className="bg-surface-light p-6 sm:p-8 md:p-10 rounded-2xl border border-slate-200 flex flex-col items-center text-center justify-between group">
            <div>
              <h3 className="font-serif text-xl sm:text-2xl text-gray-deep mb-4 break-words">{t('title2', 'pricing')}</h3>
              <p className="text-gray-deep mb-8 font-sans font-light">
                {t('desc2', 'pricing')}
              </p>
            </div>
            <div className="w-full space-y-4">
              <Link 
                ...
                target="_blank"
                className="w-full py-3 rounded-[12px] bg-white border border-slate-200 text-gray-deep font-bold flex items-center justify-center gap-2 hover:bg-slate-50 hover:scale-[1.02] active:scale-95 transition-all font-sans"
              >
